...
require (
	...
	github.com/mattermost/mattermost-server/v6 v6.0.0-20220914101306-4f363574fc96
...
exclude github.com/dyatlov/go-opengraph v0.0.0-20210112100619-dae8665a5b09
